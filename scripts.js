function updateVersionInfo() {
    ...
    switch (selectedVersion) {
        case '1.0.0':
            infoText = 'Информация о версии 1.0.0: В этой версии доступны функции:<br>  • Управление яркостью и звуком<br>  • Решение простых примеров<br>  • Получение времени<br>  • Включение автокликера<br>  • Открытие приложений<br>  • Выключение компьютера<br>  • Простое управление WASD<br>  • Создание скриншота';
        ...
        case '1.1.0':
            ...
            break;
        case '1.2.0':
            infoText = 'Информация о версии 2.1.0: Добавлены функции:<br>  • Записи экрана';
            requirementsText = '<p>Минимальные системные требования:</p><ul><li>Операционная система: Windows</li><li>Оперативная память: X MБ</li><li>Место на диске: X ГБ</li><li>Микрофон</li><li>Динамик</li></ul>';
            break;
        default:
...
function download() {
    ...
    const downloadLinks = {
        ...
        '1.2.0': 'https://drive.google.com/uc?export=download&id=ID_ДЛЯ_ВЕРСИИ_1.2.0'  // Укажите правильный ID для версии 1.2.0
    };
