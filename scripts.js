function updateVersionInfo() {
    ...
    switch (selectedVersion) {
        case '1.0.0':
            ...
            requirementsText = '<ul><li>Операционная система: Windows</li><li>Оперативная память: 6.5 МБ</li><li>Место на диске: 3 ГБ</li><li>Микрофон</li><li>Динамик</li></ul>';
            break;
        case '1.1.0':
            infoText = 'Информация о версии 1.1.0: Добавлены функции:<br>  • Записи звука';
            requirementsText = '<ul><li>Операционная система: Windows</li><li>Оперативная память: 6.5 МБ</li><li>Место на диске: 6.5 ГБ</li><li>Микрофон</li><li>Динамик</li></ul>';
            break;
        case '2.0.0':
            ...
            requirementsText = '<ul><li>Операционная система: Windows</li><li>Оперативная память: 6.3 МБ</li><li>Место на диске: 2.8 ГБ</li><li>Микрофон</li><li>Динамик</li></ul>';
            break;
        default:
    ...
    document.getElementById('systemRequirements').innerHTML = requirementsText;
}
